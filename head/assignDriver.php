...
?>
    <section class="content">
            ...
            <div class="row clearfix">
                <div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST" action="assigndriver_history.php" name="assigndriver">
		...
		<select name="group" class="form-control" required>
			...
			<?php 
$q1=mysqli_query($conn,"SELECT * FROM vehicle");
while($r1=mysqli_fetch_assoc($q1))
{
echo "<option value='".$r1['id']."'>".$r1['vehicle_name']."</option>";
}
			?>
		</select>
		</div>
                        ...
                        <div class="row" style="margin-top:10px;">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    </button>     <button type="submit" class="btn btn-primary" style="width: 100px;"><i class="fa fa-save"> </i> Save</button>
                                </div>
                            </div>
                        </div>
